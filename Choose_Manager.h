...
namespace Project1 {
	...
	/// <summary>
	/// Сводка для Choose_Manager
	/// </summary>
	public ref class Choose_Manager : public System::Windows::Forms::Form
	{
	public:
		Choose_Manager(Requests_Menu^ requests_menu_form_ref)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Click += gcnew System::EventHandler(this, &Choose_Manager::button2_Click);
			// 
			// label2
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Choose_Manager::button1_Click);
			// 
			// label1
			// 
			...
			this->label1->Text = L"Оберіть менеджера";
			...
			this->Name = L"Choose_Manager";
			this->Text = L"Choose_Manager";
