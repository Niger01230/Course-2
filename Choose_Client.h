...
namespace Project1 {
	...
	/// <summary>
	/// Сводка для Choose_Client
	/// </summary>
	public ref class Choose_Client : public System::Windows::Forms::Form
	{
	public:
		Choose_Client(Requests_Menu^ requests_menu_form_ref)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Click += gcnew System::EventHandler(this, &Choose_Client::button2_Click);
			// 
			// label2
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Choose_Client::button1_Click);
			// 
			// label1
			// 
			...
			this->label1->Text = L"Оберіть клієнта";
			...
			this->Name = L"Choose_Client";
			this->Text = L"Choose_Client";
