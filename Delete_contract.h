...
namespace Project1 {
	...
	/// <summary>
	/// Сводка для Delete_contract
	/// </summary>
	public ref class Delete_contract : public System::Windows::Forms::Form
	{
	public:
		Delete_contract(Manager^ manager_form_ref)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Location = System::Drawing::Point(359, 210);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(126, 38);
			this->button2->TabIndex = 26;
			this->button2->Text = L"Видалити";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &Delete_contract::button2_Click);
			// 
			// label2
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Delete_contract::button1_Click);
			// 
			// label1
			// 
			...
			this->Name = L"Delete_contract";
			this->Text = L"Delete_contract";
