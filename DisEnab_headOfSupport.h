...
namespace Project1 {
	...
	/// <summary>
	/// Сводка для DisEnab_headOfSupport
	/// </summary>
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Оберіть, якого голову забезпечення відключити";
			// 
			// DisEnab_headOfSupport
			// 
...
#pragma endregion
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e);
		...
		public: Void change_Disable() {
			choose = 0;
			label1->Text = "Оберіть, якого голову забезпечення відключити";
			button2->Text = "Відключити";
		}

		public: Void change_Enable() {
			choose = 1;
			label1->Text = "Оберіть, якого голову забезпечення підключити";
