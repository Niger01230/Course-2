...
namespace Project1 {
	...
	/// <summary>
	/// Сводка для Create_manager
	/// </summary>
	public ref class Create_manager : public System::Windows::Forms::Form
	{
	public:
		Create_manager(Admin^ ref_admin_form)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Click += gcnew System::EventHandler(this, &Create_manager::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Create_manager::button1_Click);
			// 
			// textBox6
			// 
			...
			this->label1->Location = System::Drawing::Point(271, 21);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(349, 29);
			this->label1->TabIndex = 15;
			this->label1->Text = L"Меню створення менеджера";
			// 
			// Create_manager
			// 
			...
			this->Name = L"Create_manager";
			this->Text = L"Create_manager";
